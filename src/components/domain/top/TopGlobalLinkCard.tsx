...
export const TopGlobalLinkCard = ({ type }: Props): JSX.Element => {
  return (
    <Link passHref href={GlobalNavigationToHref(type)}>
      <a tw='height[288px] flex items-center justify-center p-6 rounded-3xl border shadow-md bg-opacity-40 bg-blue-gray-800 border-blue-gray-700 transition ease-in-out delay-100 hover:(-translate-y-1 scale-100 bg-opacity-60)'>
        <div tw='space-y-4'>
