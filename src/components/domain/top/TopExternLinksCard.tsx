...
export const TopExternLinksCard = (): JSX.Element => {
  return (
    <div tw='lg:(col-span-1 height[288px]) md:height[auto] sm:col-span-2 row-span-1 col-span-1 height[288px] flex items-center justify-center p-4 rounded-3xl border shadow-md bg-opacity-40 bg-gray-800 border-gray-700'>
